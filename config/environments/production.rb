Shelflet::Application.configure do
  ...
  config.consider_all_requests_local       = false #true #false
...
=end
  ...
  #config.action_controller.asset_host = "https://#{ENV['shelflet_photos_prod']}.s3.amazonaws.com"  
